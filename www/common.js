...
let BookingService = class BookingService {
    ...
    addBooking(placeId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo) {
        let generatedId;
        const newBooking = new _booking_model__WEBPACK_IMPORTED_MODULE_5__["Booking"](Math.random().toString(), placeId, this.authService.userId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo);
        return this.http
            .post('https://ionic-angular-app-ab6e9.firebaseio.com/bookings.json', Object.assign({}, newBooking, { id: null })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(resData => {
    ...
    cancelBooking(bookingId) {
        return this.http
            .delete(`https://ionic-angular-app-ab6e9.firebaseio.com/bookings/${bookingId}.json`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(() => {
            return this.bookings;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(bookings => {
    ...
    fetchBookings() {
        return this.http
            .get(`https://ionic-angular-app-ab6e9.firebaseio.com/bookings.json?orderBy="userId"&equalTo="${this.authService.userId}"`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(bookingData => {
            const bookings = [];
            for (const key in bookingData) {
                if (bookingData.hasOwnProperty(key)) {
                    bookings.push(new _booking_model__WEBPACK_IMPORTED_MODULE_5__["Booking"](key, bookingData[key].placeId, bookingData[key].userId, bookingData[key].placeTitle, bookingData[key].placeImage, bookingData[key].firstName, bookingData[key].lastName, bookingData[key].guestNumber, new Date(bookingData[key].bookedFrom), new Date(bookingData[key].bookedTo)));
                }
            }
            return bookings;
